...
public:
    ...
    CInstanceHandler_MultiCast() : CHandlerBase<C, ParamType>() {}
    ...
    void ExecuteIfBound() override {
        if (this->Instance && this->MuticastFunction) {
            (this->Instance->*this->MuticastFunction)(this->Param);
        }
    }
};
...
public:
    ...
    CInstanceHandler_Single() : CHandlerBase<C, ParamType>(){}
    ...
    {
        RetType Out;
        if (this->Instance && SingleFunction)
        {
            Out = (this->Instance->*SingleFunction)(this->Param);
        }
        return Out;
    }
};