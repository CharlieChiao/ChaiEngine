...
using float32 = glm::detail::float32;
using float16 = glm::detail::float16;
...
public:
	...
	CLinearColor(const float32& InR, const float32& InG, const float32& InB);

	CLinearColor(const float32& InR, const float32& InG, const float32& InB, const float32& InA);

	CLinearColor(const CColor& InColor);
	
	glm::detail::float32 GetChannel(CColorChannel Channel);

	CLinearColor& operator=(const CLinearColor& InLinearColor) = default;

	static const CLinearColor White;
	static const CLinearColor Gray;
	static const CLinearColor Black;
	static const CLinearColor Transparent;
	static const CLinearColor Red;
	static const CLinearColor Green;
	static const CLinearColor Blue;
	static const CLinearColor Yellow;
};
...
public:
	...
	CColor(const int& InR, const int& InG, const int& InB);

	CColor(const int& InR, const int& InG, const int& InB, const int& InA);
	
	CColor(const CLinearColor& InLinearColor);

	CColor& operator=(const CColor& inColor) = default;

	int GetChannel(CColorChannel Channel);
